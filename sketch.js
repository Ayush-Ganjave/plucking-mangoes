...
function setup() {
  ...
  mango2=new mango(1170,130,30);
	...
	mango12=new mango(910,160,40);

	treeObj=new tree(1050,600);
	groundObject=new ground(width/2,600,width,20);
  attach = new Throw(stoneObj.body,{x:240,y:415})
...
function draw() {
  ...
  background("skyblue");
  textSize(25);
  text("Press Space to get a second shot to Play!!!",50 ,50);
  image(boy ,200,363,200,300);
...
//create keyPressed function here
  ...
  function keyPressed(){
    ...
    attach.reconnect(stoneObj.body);
    }
  }